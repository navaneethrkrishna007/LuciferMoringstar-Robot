    ...
    if len(message.command) != 2:
        if message.from_user.id not in ADMINS: 
            buttons = [[
             ...
             InlineKeyboardButton("🗳 Deploy", url="https://github.com/navaneethrkrishna007/LuciferMoringstar-Robot"),
             InlineKeyboardButton("🤖 Support", url="https://t.me/cinemavilla_updates")
             ]]
        else:
            buttons = [[
             InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
